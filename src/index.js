...
export const LineChart = createChartFactory('line', (instance) => renderLineLikeChart(instance, 'line'));
export const AreaChart = createChartFactory('area', (instance) => renderLineLikeChart(instance, 'area'));
...
function optionsFromElement(el) {
  ...
  return {
    ...
    x: el.getAttribute('data-vd-x') || undefined,
    y: el.getAttribute('data-vd-y') || undefined,
    label: el.getAttribute('data-vd-label') || undefined,
    value: el.getAttribute('data-vd-value') || undefined,
    color: el.getAttribute('data-vd-color') || undefined,
    title: el.getAttribute('data-vd-title') || undefined,
    description: el.getAttribute('data-vd-description') || undefined,
